...
public class Ace extends Players {
    private static final String SPRITE_PATH_WALK = "images/Fantasy_Creatures/Character_3/Move.png";
    private static final String SPRITE_PATH_IDLE = "images/Fantasy_Creatures/Character_3/Idle.png";
    private static final String SPRITE_PATH_ATTACK_1 = "images/Fantasy_Creatures/Character_3/Attack1.png";
    private static final String SPRITE_PATH_ATTACK_2 = "images/Fantasy_Creatures/Character_3/Attack2.png";
    private static final String SPRITE_PATH_BARRIERE = "images/Fantasy_Creatures/Character_3/Idle.png";
    private static final String SPRITE_PATH_TOUCHER = "images/Fantasy_Creatures/Character_3/Take_hit.png";
    private static final String SPRITE_PATH_DIE = "images/Fantasy_Creatures/Character_3/Death.png";
    ...
    private static final int FRAME_COUNT_ATTACK_1 = 10;
    private static final int FRAME_COUNT_ATTACK_2 = 10;
    ...
    public Ace(MovementController controller) {
        super(controller);
    ...
    private void loadAllAnimations() {
        ...
        attackSpecialRight = new Animation(loadAnimationFrames("images/Technique_Eau/water2/image/Ace/warer1", 14), 50);
