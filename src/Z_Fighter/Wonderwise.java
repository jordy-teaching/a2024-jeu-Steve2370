...
public class Wonderwise extends Players {
    private static final String SPRITE_PATH_WALK = "images/Fighter/Run.png";
    private static final String SPRITE_PATH_IDLE = "images/Fighter/Idle.png";
    private static final String SPRITE_PATH_ATTACK_1 = "images/Fighter/Attack_1.png";
    private static final String SPRITE_PATH_ATTACK_2 = "images/Fighter/Attack_2.png";
    private static final String SPRITE_PATH_ATTACK_3 = "images/Fighter/Attack_3.png";
    private static final String SPRITE_PATH_BARRIERE = "images/Fighter/Shield.png";
    private static final String SPRITE_PATH_TOUCHER = "images/Fighter/Hurt.png";
    private static final String SPRITE_PATH_DIE = "images/Fighter/Dead.png";
    ...
    private static final int FRAME_COUNT_ATTACK_1 = 4;
    ...
    public Wonderwise(MovementController controller) {
        super(controller);
