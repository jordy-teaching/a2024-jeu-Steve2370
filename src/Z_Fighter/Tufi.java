...
public class Tufi extends Players {
    private static final String SPRITE_PATH_WALK = "images/Fantasy_Creatures/Character_2/run.png";
    private static final String SPRITE_PATH_IDLE = "images/Fantasy_Creatures/Character_2/Idle.png";
    private static final String SPRITE_PATH_ATTACK_1 = "images/Fantasy_Creatures/Character_2/Attack1.png";
    private static final String SPRITE_PATH_ATTACK_2 = "images/Fantasy_Creatures/Character_2/Attack2.png";
    private static final String SPRITE_PATH_ATTACK_3 = "images/Fantasy_Creatures/Character_2/Attack2.png";
    private static final String SPRITE_PATH_BARRIERE = "images/Fantasy_Creatures/Character_2/Attack1.png";
    private static final String SPRITE_PATH_TOUCHER = "images/Fantasy_Creatures/Character_2/Take_hit.png";
    private static final String SPRITE_PATH_DIE = "images/Fantasy_Creatures/Character_2/Death.png";
    private Animation attackSpecialRight;
    private Animation attackSpecialLeft;

    private static final int FRAME_COUNT = 8;
    private static final int FRAME_COUNT_IDLE = 8;
    private static final int FRAME_COUNT_ATTACK_1 = 7;
    private static final int FRAME_COUNT_ATTACK_2 = 8;
    private static final int FRAME_COUNT_ATTACK_3 = 8;
    private static final int FRAME_COUNT_ATTACK_SPECIAL = 8;
    private static final int FRAME_COUNT_TOUCHER = 3;
    private static final int FRAME_COUNT_DIE = 7;
    ...
    private enum AttackType {
        NONE, ATTACK_1, ATTACK_2, ATTACK_3, BARRIERE
    }
    ...
    public Tufi(MovementController controller) {
        super(controller);
    ...
    private void loadAllAnimations() {
        ...
        attackSpecialRight = new Animation(loadAnimationFrames("images/Boss/PNG/Magic_Attacks/Feu/fire1", 10), 50);
