...
public class Baragan extends Players {
    private static final String SPRITE_PATH_WALK = "images/Fantasy_Creatures/Character_4/Run.png";
    private static final String SPRITE_PATH_IDLE = "images/Fantasy_Creatures/Character_4/Idle.png";
    private static final String SPRITE_PATH_ATTACK_1 = "images/Fantasy_Creatures/Character_4/Attack1.png";
    private static final String SPRITE_PATH_ATTACK_2 = "images/Fantasy_Creatures/Character_4/Attack2.png";
    private static final String SPRITE_PATH_BARRIERE = "images/Fantasy_Creatures/Character_4/Idle.png";
    private static final String SPRITE_PATH_TOUCHER = "images/Fantasy_Creatures/Character_4/Take_hit.png";
    private static final String SPRITE_PATH_DIE = "images/Fantasy_Creatures/Character_4/Death.png";
    ...
    private static final int FRAME_COUNT_ATTACK_1 = 8;
    ...
    private static final int FRAME_COUNT_DIE = 5;

    private static final int FRAME_WIDTH = 200;
    private static final int FRAME_HEIGHT = 200;

    private enum AttackType {
        NONE, ATTACK_1, ATTACK_2, BARRIERE
    }
    ...
    public Baragan(MovementController controller) {
        super(controller);
    ...
    private void loadAllAnimations() {
        ...
        attackSpecialRight = new Animation(loadAnimationFrames("images/Technique_feu/PNG/Explosion_5/Explosion1", 10), 50);
    ...
    private void handleInputs() {
        ...
        if (gamePad.isAttack_1() || gamePad.isAttack_2()) {
            normalAttack();
        }
