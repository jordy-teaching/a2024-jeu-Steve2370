...
public class Manon_C extends Players {
    private static final String SPRITE_PATH_WALK = "images/Countess_Vampire/Run.png";
    private static final String SPRITE_PATH_IDLE = "images/Countess_Vampire/Idle.png";
    private static final String SPRITE_PATH_ATTACK_1 = "images/Countess_Vampire/Attack_1.png";
    private static final String SPRITE_PATH_ATTACK_2 = "images/Countess_Vampire/Attack_2.png";
    private static final String SPRITE_PATH_ATTACK_3 = "images/Countess_Vampire/Attack_3.png";
    private static final String SPRITE_PATH_ATTACK_4 = "images/Countess_Vampire/Attack_4.png";
    private static final String SPRITE_PATH_BARRIERE = "images/Countess_Vampire/Hurt.png";
    private static final String SPRITE_PATH_TOUCHER = "images/Countess_Vampire/Hurt.png";
    private static final String SPRITE_PATH_DIE = "images/Countess_Vampire/Dead.png";
    private Animation attackSpecialRight;
    private Animation attackSpecialLeft;


    private static final int FRAME_COUNT = 6;
    private static final int FRAME_COUNT_IDLE = 5;
    private static final int FRAME_COUNT_ATTACK_1 = 6;
    private static final int FRAME_COUNT_ATTACK_2 = 3;
    private static final int FRAME_COUNT_ATTACK_3 = 1;
    private static final int FRAME_COUNT_ATTACK_4 = 6;
    private static final int FRAME_COUNT_BARRIERE = 8;
    private static final int FRAME_COUNT_TOUCHER = 2;
    private static final int FRAME_COUNT_DIE = 8;

    private static final int FRAME_WIDTH = 128;
    private static final int FRAME_HEIGHT = 128;

    private enum AttackType {
        NONE, ATTACK_1, ATTACK_2, ATTACK_3, ATTACK_4 , BARRIERE
    }
    ...
    public Manon_C (MovementController controller) {
        super(controller);
    ...
    private void loadAllAnimations() {
        ...
        attackSpecialRight = new Animation(loadAnimationFrames("images/Countess_Vampire/Blood/Blood_Charge1", 4), 50);
    ...
    public void updateNormalAttack() {
        if (!isAttackRealise && (currentAttack == AttackType.ATTACK_1 || currentAttack == AttackType.ATTACK_2 ||
                currentAttack == AttackType.ATTACK_3 || currentAttack == AttackType.ATTACK_4)) {
    ...
    private void handleAttacks() {
        if (currentAttack != AttackType.NONE) {
            ...
            else if (gamePad.isAttack_4()) startAttack(AttackType.ATTACK_4, FRAME_COUNT_ATTACK_4);
            else if (gamePad.isAttack_5()) startAttack(AttackType.BARRIERE, FRAME_COUNT_BARRIERE);
        }
    }
