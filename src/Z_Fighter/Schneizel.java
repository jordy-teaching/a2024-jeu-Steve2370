...
public class Schneizel extends Players {
    private static final String SPRITE_PATH_WALK = "images/Converted_Vampire/Run.png";
    private static final String SPRITE_PATH_IDLE = "images/Converted_Vampire/Idle.png";
    private static final String SPRITE_PATH_ATTACK_1 = "images/Converted_Vampire/Attack_1.png";
    private static final String SPRITE_PATH_ATTACK_2 = "images/Converted_Vampire/Attack_2.png";
    private static final String SPRITE_PATH_ATTACK_3 = "images/Converted_Vampire/Attack_3.png";
    private static final String SPRITE_PATH_BARRIERE = "images/Converted_Vampire/Protect.png";
    private static final String SPRITE_PATH_TOUCHER = "images/Converted_Vampire/Hurt.png";
    private static final String SPRITE_PATH_DIE = "images/Converted_Vampire/Dead.png";
    ...
    private static final int FRAME_COUNT_ATTACK_3 = 4;
    private static final int FRAME_COUNT_BARRIERE = 8;
    private static final int FRAME_COUNT_TOUCHER = 1;
    ...
    public Schneizel(MovementController controller) {
        super(controller);
    ...
    private void loadAllAnimations() {
        ...
        attackSpecialRight = new Animation(loadAnimationFrames("images/Boss/PNG/Magic_Attacks/Eclair/lightning1", 9), 50);
