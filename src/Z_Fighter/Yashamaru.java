...
public class Yashamaru extends Players {
    private static final String SPRITE_PATH_WALK = "images/Shinobi/Run.png";
    private static final String SPRITE_PATH_IDLE = "images/Shinobi/Idle.png";
    private static final String SPRITE_PATH_ATTACK_1 = "images/Shinobi/Attack_1.png";
    private static final String SPRITE_PATH_ATTACK_2 = "images/Shinobi/Attack_2.png";
    private static final String SPRITE_PATH_ATTACK_3 = "images/Shinobi/Attack_3.png";
    private static final String SPRITE_PATH_BARRIERE = "images/Shinobi/Shield.png";
    private static final String SPRITE_PATH_TOUCHER = "images/Shinobi/Hurt.png";
    private static final String SPRITE_PATH_DIE = "images/Shinobi/Dead.png";
    ...
    private static final int FRAME_COUNT_BARRIERE = 4;
    private static final int FRAME_COUNT_TOUCHER = 2;
    private static final int FRAME_COUNT_DIE = 4;
    ...
    public Yashamaru(MovementController controller) {
        super(controller);
